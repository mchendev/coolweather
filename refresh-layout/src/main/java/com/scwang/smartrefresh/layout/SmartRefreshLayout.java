...
//                    }
    ...
    @Override
    @Deprecated
    public SmartRefreshLayout setOnLoadmoreListener(final com.scwang.smartrefresh.layout.api.OnLoadmoreListener listener) {
    ...
    @Override
    @Deprecated
    public SmartRefreshLayout setOnRefreshLoadmoreListener(final com.scwang.smartrefresh.layout.api.OnRefreshLoadmoreListener listener) {
